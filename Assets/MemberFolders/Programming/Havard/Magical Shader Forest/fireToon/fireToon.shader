...
Shader "James/ToonFire"
{
	Properties
	{
		...
		[HDR]_Colourtop("Colour top", Color) = (0.1811172,0.04245281,1,0)
		[HDR]_Colourbottom("Colour bottom", Color) = (0,1,0.06287718,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord5 = IN.ase_texcoord3.xy * _Tiling + _Offset;
				float2 temp_cast_0 = (( _Speed * _TimeParameters.x )).xx;
				float2 texCoord14 = IN.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_0;
				...
				float2 texCoord21 = IN.ase_texcoord3.xy * temp_cast_1 + appendResult30.xy;
				float2 temp_cast_3 = (_noiseTiling).xx;
				float2 texCoord27 = IN.ase_texcoord3.xy * temp_cast_3 + appendResult30.xy;
				...
				float4 tex2DNode7 = tex2D( _Fire, lerpResult4 );
				float grayscale100 = Luminance(( tex2DNode7 * tex2DNode7.a ).rgb);
				float fireOutput47 = grayscale100;
				float4 lerpResult56 = lerp( _Colourtop , _Colourbottom , (0.0 + (fireOutput47 - 0.5) * (1.0 - 0.0) / (1.2 - 0.5)));
				...
				float3 Color = ( dualColour116 * fire68 ).rgb;
				float Alpha = ( fire68 * _Opacity );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord5 = IN.ase_texcoord2.xy * _Tiling + _Offset;
				float2 temp_cast_0 = (( _Speed * _TimeParameters.x )).xx;
				float2 texCoord14 = IN.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D1 = snoise( texCoord14*_fireDetail );
				simplePerlin2D1 = simplePerlin2D1*0.5 + 0.5;
				float time2 = 2.0;
				float2 voronoiSmoothId2 = 0;
				float2 temp_cast_1 = (_noiseTiling).xx;
				float4 appendResult30 = (float4(0.0 , ( _TimeParameters.x * _speedUp ) , 0.0 , 0.0));
				float2 texCoord21 = IN.ase_texcoord2.xy * temp_cast_1 + appendResult30.xy;
				float2 temp_cast_3 = (_noiseTiling).xx;
				float2 texCoord27 = IN.ase_texcoord2.xy * temp_cast_3 + appendResult30.xy;
				float simplePerlin2D22 = snoise( texCoord27*_fireDetail );
				simplePerlin2D22 = simplePerlin2D22*0.5 + 0.5;
				float2 temp_cast_5 = (simplePerlin2D22).xx;
				float2 lerpResult23 = lerp( texCoord21 , temp_cast_5 , float2( 0.5,0.5 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord5 = IN.ase_texcoord.xy * _Tiling + _Offset;
				float2 temp_cast_0 = (( _Speed * _TimeParameters.x )).xx;
				float2 texCoord14 = IN.ase_texcoord.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D1 = snoise( texCoord14*_fireDetail );
				simplePerlin2D1 = simplePerlin2D1*0.5 + 0.5;
				float time2 = 2.0;
				float2 voronoiSmoothId2 = 0;
				float2 temp_cast_1 = (_noiseTiling).xx;
				float4 appendResult30 = (float4(0.0 , ( _TimeParameters.x * _speedUp ) , 0.0 , 0.0));
				float2 texCoord21 = IN.ase_texcoord.xy * temp_cast_1 + appendResult30.xy;
				float2 temp_cast_3 = (_noiseTiling).xx;
				float2 texCoord27 = IN.ase_texcoord.xy * temp_cast_3 + appendResult30.xy;
				float simplePerlin2D22 = snoise( texCoord27*_fireDetail );
				simplePerlin2D22 = simplePerlin2D22*0.5 + 0.5;
				float2 temp_cast_5 = (simplePerlin2D22).xx;
				float2 lerpResult23 = lerp( texCoord21 , temp_cast_5 , float2( 0.5,0.5 ));
				...
				surfaceDescription.Alpha = ( fire68 * _Opacity );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord5 = IN.ase_texcoord1.xy * _Tiling + _Offset;
				float2 temp_cast_0 = (( _Speed * _TimeParameters.x )).xx;
				float2 texCoord14 = IN.ase_texcoord1.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D1 = snoise( texCoord14*_fireDetail );
				simplePerlin2D1 = simplePerlin2D1*0.5 + 0.5;
				float time2 = 2.0;
				float2 voronoiSmoothId2 = 0;
				float2 temp_cast_1 = (_noiseTiling).xx;
				float4 appendResult30 = (float4(0.0 , ( _TimeParameters.x * _speedUp ) , 0.0 , 0.0));
				float2 texCoord21 = IN.ase_texcoord1.xy * temp_cast_1 + appendResult30.xy;
				float2 temp_cast_3 = (_noiseTiling).xx;
				float2 texCoord27 = IN.ase_texcoord1.xy * temp_cast_3 + appendResult30.xy;
				float simplePerlin2D22 = snoise( texCoord27*_fireDetail );
				simplePerlin2D22 = simplePerlin2D22*0.5 + 0.5;
				float2 temp_cast_5 = (simplePerlin2D22).xx;
				float2 lerpResult23 = lerp( texCoord21 , temp_cast_5 , float2( 0.5,0.5 ));
...
/*ASEBEGIN
Version=19002
2495.333;-471.3333;1300.667;825;929.3813;300.5984;1.329627;True;False
Node;AmplifyShaderEditor.CommentaryNode;57;-4409.72,-1486.872;Inherit;False;3709.782;1871.214;Comment;31;47;7;4;5;3;33;20;2;1;19;34;23;14;17;22;21;26;18;27;30;25;9;29;31;16;32;100;101;131;133;145;fireEffect;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleTimeNode;16;-4323.536,-867.5835;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-4352.72,-137.9089;Inherit;False;Property;_speedUp;speedUp;5;0;Create;True;0;0;0;False;0;False;-0.14;-0.5;-0.3;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;101;-3986.041,90.81342;Inherit;False;Property;_noiseTiling;noiseTiling;8;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-3463.246,-1077.481;Inherit;False;Property;_Speed;Speed;2;0;Create;True;0;0;0;False;0;False;-0.15;-0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;71;-4509.29,1012.959;Inherit;False;2674.198;785.6093;Comment;12;36;37;38;40;39;41;42;44;45;49;48;68;fireFinished;1,1,1,1;0;0
Node;AmplifyShaderEditor.Vector2Node;19;-2535.811,-1436.872;Inherit;False;Property;_Tiling;Tiling;3;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;20;-2552.811,-1140.872;Inherit;False;Property;_Offset;Offset;4;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;34;-2546.657,-248.2976;Inherit;False;Property;_firePower;firePower;6;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;36;-4459.29,1062.959;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SqrtOpNode;37;-4117.688,1172.517;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;38;-3871.376,1199.468;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;131;-1408.976,-731.6555;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;39;-3615.376,1296.468;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-3760.928,1539.569;Inherit;False;Property;_fireTreshold;fireTreshold;7;0;Create;True;0;0;0;False;0;False;-0.5;-0.5;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;41;-3355.927,1395.568;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCGrayscale;100;-1156.828,-762.9994;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;-3092.927,1405.568;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;47;-929.9093,-735.2249;Inherit;False;fireOutput;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;48;-2834.289,1169.681;Inherit;False;47;fireOutput;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;44;-2828.03,1389.403;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;45;-2566.039,1308.783;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;49;-2301.074,1331.27;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;68;-2059.092,1347.04;Inherit;False;fire;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;147;-409.9404,241.4462;Inherit;False;Property;_Opacity;Opacity;14;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;58;-193.9972,-2545.531;Inherit;False;1609.302;859.5372;Comment;15;85;84;83;86;115;112;73;114;113;72;56;54;55;99;116;dualColours;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;70;-430.5001,126.6608;Inherit;False;68;fire;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;113;417.9497,-2291.634;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;73;200.6227,-2222.443;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;0.8;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;146;-33.65606,-29.79771;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-172.0152,-216.9676;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SmoothstepOpNode;99;489.0481,-2017.647;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;72;225.0997,-2481.702;Inherit;False;47;fireOutput;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;50;-694.0242,-710.5565;Inherit;False;Property;_Colour;Colour;9;1;[HDR];Create;True;0;0;0;False;0;False;3.1,1.1,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;145;-2019.192,-107.6614;Inherit;True;Property;_TextureSample0;Texture Sample 0;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;117;-416.239,-400.6089;Inherit;False;116;dualColour;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;115;181.9497,-2009.634;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;54;495.7265,-2483.124;Inherit;False;Property;_Colourtop;Colour top;10;1;[HDR];Create;True;0;0;0;False;0;False;0.1811172,0.04245281,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;133;-1901.734,-338.6106;Inherit;False;0;0;_QueueOffset;Shader;False;0;5;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;69;-413.718,-197.5788;Inherit;False;68;fire;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;56;820.6499,-2103.409;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
WireConnection;56;2;73;0
WireConnection;112;0;86;0
WireConnection;114;0;113;0
WireConnection;136;2;51;0
WireConnection;136;3;146;0
ASEEND*/
//CHKSM=2021FD4F58C5C36D686608C7E059337B4325BD2F
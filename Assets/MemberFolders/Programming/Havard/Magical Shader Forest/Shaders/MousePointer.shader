...
Shader "MousePointer"
{
	Properties
	{
		...
		[ASEBegin]_Pointer("Pointer", 2D) = "white" {}
		_MainColour("Main Colour", Color) = (0,0,0,0)
		_ShadowColour("Shadow Colour", Color) = (0,0,0,0)
		_Charge("Charge", Range( 0 , 1)) = 0
		_MainColourCharged("Main Colour Charged", Color) = (0,0,0,0)
		[ASEEnd]_ShadowColourCharged("Shadow Colour Charged", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _MainColourCharged;
			float4 _ShadowColourCharged;
			float _Charge;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_Pointer = IN.ase_texcoord3.xy * _Pointer_ST.xy + _Pointer_ST.zw;
				float4 tex2DNode11 = tex2D( _Pointer, uv_Pointer );
				float4 MainColours28 = tex2DNode11;
				float4 break33 = MainColours28;
				float4 Normalcolours36 = ( ( _MainColour * break33.r ) + ( _ShadowColour * break33.g ) );
				float4 break30 = MainColours28;
				float4 Chargedcolours31 = ( ( break30.r * _MainColourCharged ) + ( break30.g * _ShadowColourCharged ) );
				float4 lerpResult19 = lerp( Normalcolours36 , Chargedcolours31 , _Charge);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Pointer = IN.ase_texcoord2.xy * _Pointer_ST.xy + _Pointer_ST.zw;
				float4 tex2DNode11 = tex2D( _Pointer, uv_Pointer );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Pointer = IN.ase_texcoord.xy * _Pointer_ST.xy + _Pointer_ST.zw;
				float4 tex2DNode11 = tex2D( _Pointer, uv_Pointer );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Pointer = IN.ase_texcoord1.xy * _Pointer_ST.xy + _Pointer_ST.zw;
				float4 tex2DNode11 = tex2D( _Pointer, uv_Pointer );
...
/*ASEBEGIN
Version=19002
2555.333;-471.3333;1045.333;902.3333;1945.388;641.6258;2.528126;True;False
Node;AmplifyShaderEditor.CommentaryNode;35;-783.2656,-659.2747;Inherit;False;956.9552;611.5496;Comment;8;34;33;17;15;12;16;13;36;Normal colours;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;27;-888.0018,967.1437;Inherit;False;956.6586;702.0731;Comment;8;29;20;21;24;22;23;30;31;Charged colours;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;11;-140.2963,166.059;Inherit;True;Property;_Pointer;Pointer;0;0;Create;True;0;0;0;False;0;False;-1;91aa82db89e40564c908ca9e75cdb12a;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;28;237.1317,218.1882;Inherit;False;MainColours;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;37;-237.0326,377.4099;Inherit;False;36;Normalcolours;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;19;45.92349,437.129;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;31;-169.5128,1116.771;Inherit;False;Chargedcolours;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;36;-20.22198,-349.8401;Inherit;False;Normalcolours;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;34;-733.2656,-229.0612;Inherit;False;28;MainColours;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.BreakToComponentsNode;33;-536.2537,-226.7251;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-140.9215,-350.6331;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-340.8297,-290.7995;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;12;-654.0558,-609.2747;Inherit;False;Property;_MainColour;Main Colour;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-340.8298,-446.0882;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;13;-673.0623,-430.9016;Inherit;False;Property;_ShadowColour;Shadow Colour;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;29;-837.1848,1479.022;Inherit;False;28;MainColours;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.BreakToComponentsNode;30;-640.173,1481.358;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.GetLocalVarNode;32;-256.0841,510.6263;Inherit;False;31;Chargedcolours;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-500.6584,1054.017;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;23;-312.893,1117.144;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-491.7148,1197.807;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;20;-818.9951,1065.872;Inherit;False;Property;_MainColourCharged;Main Colour Charged;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;21;-838.0016,1244.245;Inherit;False;Property;_ShadowColourCharged;Shadow Colour Charged;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-274.3236,676.9005;Inherit;False;Property;_Charge;Charge;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;223.4809,333.4921;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;12;MousePointer;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;1;638061731366664554;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638061729330377487;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
WireConnection;22;0;30;1
WireConnection;22;1;21;0
WireConnection;2;2;19;0
WireConnection;2;3;11;4
ASEEND*/
//CHKSM=16A7B7F3A6C263A33869D7031D89B38549FF3334
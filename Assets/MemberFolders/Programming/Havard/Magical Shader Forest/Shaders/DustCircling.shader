...
Shader "DustCircling"
{
	Properties
	{
		...
		[ASEBegin]_Panning("Panning", Vector) = (0,0,0,0)
		_Offset("Offset", Vector) = (0,0,0,0)
		_Tiling("Tiling", Vector) = (1,1,0,0)
		_Texture("Texture", 2D) = "white" {}
		_Colour("Colour", Color) = (0.990566,0.6157143,0.3613385,1)
		[ASEEnd][Toggle]_UseAlpha("Use Alpha", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord11 = IN.ase_texcoord3.xy * _Tiling + _Offset;
				float2 panner12 = ( 1.0 * _Time.y * _Panning + texCoord11);
				float4 tex2DNode16 = tex2D( _Texture, panner12 );
				
				float4 temp_cast_1 = (tex2DNode16.a).xxxx;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Colour * tex2DNode16 ).rgb;
				float Alpha = ( _Colour.a * (( _UseAlpha )?( temp_cast_1 ):( tex2DNode16 )) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord11 = IN.ase_texcoord2.xy * _Tiling + _Offset;
				float2 panner12 = ( 1.0 * _Time.y * _Panning + texCoord11);
				float4 tex2DNode16 = tex2D( _Texture, panner12 );
				float4 temp_cast_0 = (tex2DNode16.a).xxxx;
				

				float Alpha = ( _Colour.a * (( _UseAlpha )?( temp_cast_0 ):( tex2DNode16 )) ).r;
				float AlphaClipThreshold = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord11 = IN.ase_texcoord.xy * _Tiling + _Offset;
				float2 panner12 = ( 1.0 * _Time.y * _Panning + texCoord11);
				float4 tex2DNode16 = tex2D( _Texture, panner12 );
				float4 temp_cast_0 = (tex2DNode16.a).xxxx;
				

				surfaceDescription.Alpha = ( _Colour.a * (( _UseAlpha )?( temp_cast_0 ):( tex2DNode16 )) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord11 = IN.ase_texcoord1.xy * _Tiling + _Offset;
				float2 panner12 = ( 1.0 * _Time.y * _Panning + texCoord11);
				float4 tex2DNode16 = tex2D( _Texture, panner12 );
				float4 temp_cast_0 = (tex2DNode16.a).xxxx;
...
/*ASEBEGIN
Version=19002
2694.667;-471.3333;1200.667;657.6667;1956.267;972.2477;2.790083;True;False
Node;AmplifyShaderEditor.Vector2Node;15;-1047.082,276.1836;Inherit;False;Property;_Offset;Offset;1;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;14;-1067.082,-39.81647;Inherit;False;Property;_Tiling;Tiling;2;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;13;-645.0818,268.1836;Inherit;False;Property;_Panning;Panning;0;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-753.2344,-23.47168;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;12;-459.5715,4.802034;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;20;-142.6959,-198.1992;Inherit;False;Property;_Colour;Colour;4;0;Create;True;0;0;0;False;0;False;0.990566,0.6157143,0.3613385,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;25;206.5468,132.0674;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-190.8792,2.006161;Inherit;True;Property;_Texture;Texture;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;26;463.9467,189.2674;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;24;199.6305,238.7024;Inherit;False;Property;_UseAlpha;Use Alpha;5;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;559.1789,275.7976;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;264.1042,-98.79919;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;791.6567,-87.14349;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;12;DustCircling;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;1;638060131372398653;  Blend;0;0;Two Sided;0;638060129959860162;Forward Only;0;0;Cast Shadows;0;638060138729262279;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=54A9EDF157C4419C9AB724F7BEC67815ABECE932
...
Shader "James/Blood"
{
	Properties
	{
		...
		[ASEBegin]_Bloodtexture("Blood texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_Bloodtexture = IN.ase_texcoord3.xy * _Bloodtexture_ST.xy + _Bloodtexture_ST.zw;
				float4 tex2DNode1 = tex2D( _Bloodtexture, uv_Bloodtexture );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Colour * tex2DNode1 ).rgb;
				float Alpha = ( tex2DNode1 * _Opacity * tex2DNode1.a ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Bloodtexture = IN.ase_texcoord2.xy * _Bloodtexture_ST.xy + _Bloodtexture_ST.zw;
				float4 tex2DNode1 = tex2D( _Bloodtexture, uv_Bloodtexture );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Bloodtexture = IN.ase_texcoord.xy * _Bloodtexture_ST.xy + _Bloodtexture_ST.zw;
				float4 tex2DNode1 = tex2D( _Bloodtexture, uv_Bloodtexture );
				

				surfaceDescription.Alpha = ( tex2DNode1 * _Opacity * tex2DNode1.a ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Bloodtexture = IN.ase_texcoord1.xy * _Bloodtexture_ST.xy + _Bloodtexture_ST.zw;
				float4 tex2DNode1 = tex2D( _Bloodtexture, uv_Bloodtexture );
...
/*ASEBEGIN
Version=19002
2999.333;72.66667;916.0001;777;869.8061;218.6478;1.048301;True;False
Node;AmplifyShaderEditor.SamplerNode;1;-699.0293,42.92169;Inherit;True;Property;_Bloodtexture;Blood texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;5;-433.3232,290.1403;Inherit;False;Property;_Opacity;Opacity;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;3;-651.1046,-160.3083;Inherit;False;Property;_Colour;Colour;1;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2;-297.1045,-67.3083;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4;-245.3232,155.1402;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-179.7817,-217.5976;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3C6A021416709BB0BE81CCAC22A2E8E5FEDE9BB1